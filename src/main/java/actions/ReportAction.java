...
public class ReportAction extends ActionBase {
    ...
    public void create() throws ServletException, IOException {
        ...
        if (checkToken()) {
            ...
            int likeCount = Integer.parseInt(getRequestParam(AttributeConst.REP_LIKE_COUNT));
    ...
    public void likeCount() throws ServletException, IOException {
        ...
        if (errors.size() > 0) {
            ...
            // flush
            putSessionScope(AttributeConst.FLUSH, rv.getEmployee().getName() + "さんの日報にいいね！しました");
